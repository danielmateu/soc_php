...
<body class="container p-4 position-relative">
    ...
    <main class="p-2" id=''>
        ...
        <section class="mb-5" id="">
            <h2>Simplificando la conexión</h2>
            ...
            <p>
                ...
                si no organizamos bien el código, podemos tener
                problemas cuando modifiquemos los datos de conexión o al editar
                nuestros programas (cosas que dejan de funcionar).
            </p>

            <p>
                Para evitar esto, podemos crear un archivo con las funciones
                necesarias para conectarnos a la base de datos y realizar
                consultas. <br>

                De esta forma, si necesitamos cambiar algo, solo tendremos que
