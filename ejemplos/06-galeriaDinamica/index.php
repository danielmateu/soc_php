...
<body class="container p-4 position-relative">
    ...
    <main class="p-2">
        ...
        <section class="mb-5" id="ejemplo">
            ...
            // Listado de directorio con readdir()
            $directorio = ('imagenes');
            // echo '<h3>Listado de ficheros en el directorio ./imagenes</h3>';
            $archivos = [];

            $handler = opendir($directorio);

            while ($archivo = readdir($handler)) {
                if ($archivo != '.' && $archivo != '..') {
                    $archivos[] = $archivo;
                }
            }
            ...
            <div class="d-flex flex-wrap  gap-3">
                ...
                foreach ($archivos as $archivo) {
                    ...
                    echo "<img src='./imagenes/$archivo' alt='$archivo' class='img-fluid rounded'>";
                    echo "<figcaption class='figure-caption'>$archivo</figcaption>";
                    echo "</figure>";
                }
                ?>
            </div>
