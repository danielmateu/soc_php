...
<body class="container p-4 position-relative">
    ...
    <main class="p-2" id=''>
        ...
        <section class="mb-5">
            ...
            <p>La idea es crear un objeto tipo Email, con los parámetros
                adecuados y llamar a un método enviar() que retornará true o false.</p>

            <p>Para ello, crearemos un formulario que nos permitirá introducir los datos
                necesarios para crear el objeto Email y enviarlo.</p>   
