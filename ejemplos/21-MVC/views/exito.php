...
<body class="container p-4 position-relative">
    ...
    <header class="header d-flex bg-dark p-4 mb-4 position-sticky top-0 start-0  col-12 rounded opacity-4 align-items-center" id="menu">
        <h1 class="text-white">Exito</h1>
