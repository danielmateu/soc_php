...
<body class="container p-4 position-relative">
    ...
    <main class="p-2" id=''>
        ...
        <section class="mb-5" id="sesiones">
            ...
            // Preparamos una consulta para eliminar un registro
            $consulta = $conexion->prepare('DELETE FROM libros WHERE id = 34');

            // Lanza la consulta preparada
            $consulta->execute();

            // Comprobamos si se ha eliminado el registro
            if ($consulta->affected_rows > 0) {
                // Mostramos qué libro se ha eliminado
                echo '<p>Se ha eliminado el libro con id ' . $conexion->insert_id . '</p>';

            } else {
                echo '<p>No se ha eliminado el registro</p>';
            }
